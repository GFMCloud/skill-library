...
# Usage: bash maintainers/scripts/generate-inventory.sh          # regenerate docs/inventory.md
#        bash maintainers/scripts/generate-inventory.sh --check  # exit 1 if the committed file is stale
