...
- 2026-09-02, Graham: row 7 overridden to out after the trade-off summary (partial control, hard blocks, no logged burn). Side effects of the original proposal: none in the repo; the paste script and proof fixture were scratch-only and die with the session. The prose rule in `~/.claude/CLAUDE.md` remains the control.
- 2026-09-02, Graham: row 6 out; record closed. Row 5's prose procedure in the generated rule 6 is the control for bug fixes. No side effects: nothing was scaffolded.
