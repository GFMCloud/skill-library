...
- **A map of the packs** on the main README, `docs/images/pack-map.svg`: which five packs
  need `foundry-core` and which six install on their own, with skill and agent counts.
  It is generated by `maintainers/scripts/generate-pack-map.py` from `marketplace.json`,
