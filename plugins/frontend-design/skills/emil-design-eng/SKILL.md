...
The Sonner Principles (Building Loved Components), Stagger Animations, and Debugging
Animations are in [references/techniques-and-craft.md](references/techniques-and-craft.md).
