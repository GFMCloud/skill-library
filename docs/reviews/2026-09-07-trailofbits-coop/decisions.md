...
2026-09-07: ratified in claude-scout-weekly `/phase ratify` (Graham, interactive). Row 5 applied the same evening; rows 3 and 4 applied to the hooks runbook with Q-2026-09-07-3; row 1 tabled until a named week; row 6 deferred. Recorded as Q-2026-09-07-7 ruling.
