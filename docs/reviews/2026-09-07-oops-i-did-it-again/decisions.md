...
2026-09-08: rows 1 and 6 applied (replay-hooks runbook run; result in claude-scout-weekly `docs/runbooks/2026-09-07-replay-hooks.result.md`). Row 2 (evidence-guard hook) is now unblocked.
